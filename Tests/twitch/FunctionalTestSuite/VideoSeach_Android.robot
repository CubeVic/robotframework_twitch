...
*** Keywords ***
pixel=Pixel 5        s8=Samsung Galaxy S8+       fold=Galaxy Fold       as1=Samsung Galaxy AS1/71
...
Samsung Galaxy AS1/71
    Android devices
    Define mobile browser       ${MOBILE_DEVICES_Android}[as1]
